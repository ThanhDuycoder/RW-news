...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 7725416919050836962),
      name: 'Article',
      lastPropertyId: const obx_int.IdUid(5, 8409367686164018062),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8321132036604978987),
            name: 'id',
            type: 6,
            flags: 129),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 1640231143242442954),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 2751753885863451156),
            name: 'source',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 758847851203937012),
            name: 'publishDate',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 8409367686164018062),
            name: 'imagePath',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 7725416919050836962),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Article: obx_int.EntityDefinition<Article>(
        ...
        objectToFB: (Article object, fb.Builder fbb) {
          ...
          fbb.addInt64(3, object.publishDate.millisecondsSinceEpoch);
...
class Article_ {
  ...
  /// See [Article.publishDate].
  static final publishDate =
      obx.QueryDateProperty<Article>(_entities[0].properties[3]);

  /// See [Article.imagePath].
